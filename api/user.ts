...
import { UserDto, CreateBlogResDto, Blogs, PrivateBlogs, DetailBlogDto } from './type';

import { postData, getData, putData } from '@/fetch';

/**
 * 创建博客 需要登录
 * @param {any} body 创建博客的body数据
 */
export const blogCreate = (body: any) => postData(`/blog/create`, Object.assign({}, body));
